  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 p-4 md:p-6 flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 row-span-2 bg-white p-4">
            <div className="mb-4">
              <h2 className="text-lg font-semibold">State Table</h2>
            </div>
            <div>
              <Textarea 
                value={stateTable} 
          ...
          <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
            ...
            <div className=" bg-white p-4">
              <div className="mb-4">
                <h2 className="text-lg font-semibold">State Graph</h2>
              </div>
            ...
            <div className=" bg-white p-4">
              <div className="mb-4">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg font-semibold">Tape</h2>
              ...
              <div>
                <TuringMachine tape={tape} headPos={headPosition} currentState={currentState} />
            ...
            <div className=" bg-white p-4">
              ...
              <div className="h-[200px] overflow-y-auto font-mono text-xs bg-gray-50 p-2 rounded">
                {debugLog.map((log, index) => <div key={index}>
                  {log.startsWith('#') ? <span className="text-gray-500">{log}</span> : 
                   ...
                   log.includes('Step') ? <span className="text-green-500">{log}</span> : 
